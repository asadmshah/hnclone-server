...
public class CommentsDatabaseTest extends BaseDatabaseTest {
    ...
    public void test1() throws Exception {
        ...
        assertThat(cdb.incrementScore(user1.getId(), comment5.getId())).isEqualTo(1);
        ...
        assertThat(cdb.incrementScore(user4.getId(), comment8.getId())).isEqualTo(1);
        ...
        assertThat(cdb.incrementScore(user1.getId(), comment10.getId())).isEqualTo(1);
        ...
        assertThat(cdb.decrementScore(user3.getId(), comment14.getId())).isEqualTo(-1);
        Comment comment15 = cdb.create(user3.getId(), post1.getId(), comment10.getId(), "Comment 15");
        assertThat(comment15).isNotNull();
        assertThat(cdb.decrementScore(user3.getId(), comment15.getId())).isEqualTo(-1);
        ...
        assertThat(cdb.decrementScore(user2.getId(), comment18.getId())).isEqualTo(-1);
